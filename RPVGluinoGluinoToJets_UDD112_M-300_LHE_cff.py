# LHE step only for the RPV_GluinoGluinoto6Q M-300 gridpack.
#   cmsDriver.py Configuration/GenProduction/python/RPVGluinoGluinoToJets_UDD112_M-300_LHE_cff.py \
#     --step LHE --eventcontent LHE --datatier LHE \
#     --fileout file:RPV_M300_LHE.root -n 20000 ...
