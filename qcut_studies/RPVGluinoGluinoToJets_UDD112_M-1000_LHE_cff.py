# LHE step only for the RPV_GluinoGluinoto6Q M-1000 gridpack.
#   cmsDriver.py Configuration/GenProduction/python/RPVGluinoGluinoToJets_UDD112_M-1000_LHE_cff.py \
#     --step LHE --eventcontent LHE --datatier LHE \
#     --fileout file:RPV_M1000_LHE.root -n 20000 ...
